...
from Bctchinna.cmd_help import *


@Client.on_callback_query()
async def _callbacks(Bctchinna: Client, callback_query: CallbackQuery):
    user = await Bctchinna.get_me()
    user.mention
    ...
    if query.startswith("helpmenu1"):
        if query == "helpmenu1":
            ...
            await Bctchinna.edit_message_text(
                chat_id=chat_id,
